...
String DotSceneLoader::getAttrib(TiXmlElement *XMLNode, const char *attrib, const String &defaultValue)
{
...
Real DotSceneLoader::getAttribReal(TiXmlElement *XMLNode, const char *attrib, Real defaultValue)
{
    if(XMLNode->Attribute(attrib))
...
bool DotSceneLoader::getAttribBool(TiXmlElement *XMLNode, const char *attrib, bool defaultValue)
{
    if(!XMLNode->Attribute(attrib))
        return defaultValue;
