...
namespace Ogre
{
    ...
    protected:
        ...
        String getAttrib(TiXmlElement *XMLNode, const char *parameter, const String &defaultValue = "");
        Real getAttribReal(TiXmlElement *XMLNode, const char *parameter, Real defaultValue = 0);
        bool getAttribBool(TiXmlElement *XMLNode, const char *parameter, bool defaultValue = false);
